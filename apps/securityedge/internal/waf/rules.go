...
func BuiltinRules() []Rule {
	...
	specs := []spec{
		...
		{"PATH-002", "Sensitive file probe", "recon", "Detects requests for commonly exposed secrets and system files.", `(?i)(?:^|[/\\])(?:\.env|\.git(?:[/\\]|$)|wp-config\.php|etc[/\\]passwd|etc[/\\]shadow|id_rsa|web\.config|application\.properties)(?:$|[/\\?])`, 5, []string{"path", "query"}},
